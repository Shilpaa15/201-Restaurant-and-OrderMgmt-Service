...
public class CustomerResponse {
		...
		public String toString() {
			return "CustomerResponse [restaurantId=" + restaurantId + ", itemDetail=" + itemDetail + ", totalPrice="
					+ totalPrice + ", orderTime=" + orderTime + ", specialNote=" + specialNote + ", deliveryTime="
					+ deliveryTime + ", paymentId=" + paymentId + ", customerName=" + customerName + ", customerCellNo="
					+ customerCellNo + ", status=" + status + "]";
		}
